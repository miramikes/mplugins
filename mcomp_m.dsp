...
mcomp_m = bypass1(cbp,comp_mono_d);

   comp_g(x) = hgroup("COMPRESSOR MONO  [tooltip: Reference: http://en.wikipedia.org/wiki/Dynamic_range_compression]", x);
   ...
   comp_mono_d =
     displaygain(compressor_mono(ratio,threshold,attack,release)) :  *(makeupgain);
...
process =   vmeter_m_in : mcomp_m : vmeter_m_out ;
